    ...
    try {
        ...
        switch (request.params.name) {
            case "coingecko_price":
                return await handleSimplePrice(requestParams.ids, requestParams.vs_currencies, requestParams.include_market_cap, requestParams.include_24hr_vol, requestParams.include_24hr_change);
            case "coingecko_list":
                return await handleCoinList(requestParams.include_platform);
            case "coingecko_coin_data":
                return await handleCoinData(requestParams.id, requestParams.vs_currencies);
